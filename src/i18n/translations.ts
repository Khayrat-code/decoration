...
const T = {
  ...
  complaints: {
    ...
    title:   { ar: 'صوتك يصنع الفرق.', en: 'Your voice makes the difference.' },
    body: {
      ar: 'في TOOLCAN نعتبر ملاحظاتك جزءًا أساسيًا من تطورنا. سواء كانت لديك ملاحظة، شكوى، أو فكرة جديدة، نحرص على الاستماع إليها والتعامل معها باهتمام واحترافية.',
      en: 'At TOOLCAN, we consider your feedback an essential part of our growth. Whether you have a remark, a complaint, or a new idea, we make sure to listen to it and handle it with care and professionalism.',
    },
    formHeading: { ar: 'شاركنا رأيك', en: 'Share your feedback' },
    form: {
      type:        { ar: 'نوع الطلب', en: 'Request type' },
      typeHint:    { ar: 'شكوى · اقتراح · ملاحظة · استفسار', en: 'Complaint · Suggestion · Remark · Inquiry' },
      typeComplaint:   { ar: 'شكوى', en: 'Complaint' },
      typeSuggestion:  { ar: 'اقتراح', en: 'Suggestion' },
      typeRemark:      { ar: 'ملاحظة', en: 'Remark' },
      typeInquiry:     { ar: 'استفسار', en: 'Inquiry' },
      name:        { ar: 'الاسم', en: 'Name' },
      namePh:      { ar: 'اكتب اسمك', en: 'Enter your name' },
      phone:       { ar: 'رقم الجوال', en: 'Mobile number' },
      phonePh:     { ar: '05XXXXXXXX', en: '05XXXXXXXX' },
      email:       { ar: 'البريد الإلكتروني', en: 'Email' },
      emailPh:     { ar: 'البريد الإلكتروني', en: 'Email address' },
      orderRef:    { ar: 'رقم المشروع أو الطلب — إن وجد', en: 'Project or order number — if any' },
      orderRefPh:  { ar: 'رقم الطلب', en: 'Order number' },
      message:     { ar: 'رسالتك', en: 'Your message' },
      messagePh: {
        ar: 'اكتب تفاصيل الشكوى أو الاقتراح',
        en: 'Write the details of your complaint or suggestion',
      },
      attachment:   { ar: 'إرفاق ملف — اختياري', en: 'Attach a file — optional' },
      attachmentPh: { ar: 'إرفاق صورة أو مستند', en: 'Attach an image or document' },
      attachmentHint: { ar: 'JPG، PNG، أو PDF. حتى ١٠ ميغابايت.', en: 'JPG, PNG, or PDF. Up to 10 MB.' },
      afterHeading: { ar: 'بعد الإرسال', en: 'After submitting' },
      afterBody: {
        ar: 'سيتم تسجيل طلبك ومراجعته من الفريق المختص، والتواصل معك عند الحاجة أو بعد الانتهاء من معالجة الطلب.',
        en: 'Your request will be logged and reviewed by the relevant team, who will reach out if needed or once it has been resolved.',
      },
      tagline:     { ar: 'نستمع. نراجع. نطوّر.', en: 'We listen. We review. We improve.' },
      submit:      { ar: 'إرسال الطلب', en: 'Submit request' },
      submitting:  { ar: 'جاري الإرسال…', en: 'Submitting…' },
      sendAnother: { ar: 'إرسال طلب آخر', en: 'Send another request' },
      success: {
        title: { ar: 'شكرًا لوقتك.', en: 'Thank you for your time.' },
        body:  {
          ar: 'سيتم تسجيل طلبك ومراجعته من الفريق المختص، والتواصل معك عند الحاجة أو بعد الانتهاء من معالجة الطلب.',
          en: 'Your request has been logged and will be reviewed by the relevant team, who will reach out if needed or once it has been resolved.',
        },
      },
      errors: {
        required: { ar: 'يرجى تعبئة الاسم والبريد الإلكتروني والرسالة.', en: 'Please fill in name, email, and your message.' },
        email:    { ar: 'صيغة البريد الإلكتروني غير صحيحة.', en: 'That email doesn’t look quite right.' },
        fileTooBig: { ar: 'حجم الملف أكبر من ١٠ ميغابايت.', en: 'The file is larger than 10 MB.' },
      },
    },
  ...
  policies: {
    ...
    privacy: {
      ...
      intro: {
        ar: 'خصوصيتك محل اهتمامنا. في TOOLCAN نلتزم بحماية بيانات عملائنا والتعامل معها بسرية ومسؤولية، وفق الأنظمة واللوائح المعمول بها في المملكة العربية السعودية.',
        en: 'Your privacy matters to us. At TOOLCAN we are committed to protecting our clients’ data and handling it with confidentiality and responsibility, in line with the laws and regulations in force in the Kingdom of Saudi Arabia.',
      },
      body: {
        ar: 'خصوصيتك محل اهتمامنا. في TOOLCAN نلتزم بحماية بيانات عملائنا والتعامل معها بسرية ومسؤولية، وفق الأنظمة واللوائح المعمول بها في المملكة العربية السعودية.',
        en: 'Your privacy matters to us. At TOOLCAN we are committed to protecting our clients’ data and handling it with confidentiality and responsibility, in line with the laws and regulations in force in the Kingdom of Saudi Arabia.',
      },
      whatTitle: { ar: 'ماذا نجمع؟', en: 'What do we collect?' },
      whatBody: {
        ar: 'قد نحتاج إلى بعض المعلومات مثل الاسم، رقم الجوال، البريد الإلكتروني، تفاصيل المشروع أو الطلب، وأي ملفات أو معلومات تختار مشاركتها معنا.',
        en: 'We may need some information such as your name, mobile number, email address, project or order details, and any files or information you choose to share with us.',
      },
      whyTitle: { ar: 'لماذا نستخدم بياناتك؟', en: 'Why do we use your data?' },
      whyIntro: {
        ar: 'نستخدم معلوماتك فقط بالقدر اللازم من أجل:',
        en: 'We use your information only to the extent necessary in order to:',
      },
      whyItems: [
        { ar: 'التواصل معك والرد على استفساراتك.', en: 'Communicate with you and respond to your inquiries.' },
        { ar: 'تقديم خدماتنا وإدارة مشاريعك.', en: 'Provide our services and manage your projects.' },
        { ar: 'إعداد عروض الأسعار والعقود والفواتير.', en: 'Prepare quotations, contracts, and invoices.' },
        { ar: 'تحسين خدماتنا وتجربة العملاء.', en: 'Improve our services and the client experience.' },
        { ar: 'معالجة الشكاوى والاقتراحات.', en: 'Process complaints and suggestions.' },
        { ar: 'الوفاء بالالتزامات النظامية.', en: 'Fulfil our regulatory obligations.' },
      ],
      protectTitle: { ar: 'حماية معلوماتك', en: 'Protecting your information' },
      protectBody: {
        ar: 'نتخذ الإجراءات المناسبة لحماية بياناتك من الوصول أو الاستخدام أو الإفصاح غير المصرح به، ولا نقوم ببيع بياناتك الشخصية. وقد تتم مشاركة بعض البيانات مع أطراف مرتبطة بتنفيذ الخدمة عند الحاجة، أو عندما يكون ذلك مطلوبًا نظامًا.',
        en: 'We take appropriate measures to protect your data from unauthorised access, use, or disclosure, and we do not sell your personal data. Some data may be shared with parties involved in delivering the service when necessary, or when required by law.',
      },
      rightsTitle: { ar: 'حقوقك', en: 'Your rights' },
      rightsBody: {
        ar: 'يمكنك طلب الوصول إلى بياناتك الشخصية أو تصحيحها أو تحديثها أو حذفها، أو ممارسة أي من حقوقك النظامية المتعلقة ببياناتك، وفقًا للأنظمة والضوابط المعمول بها.',
        en: 'You may request access to, correction, updating, or deletion of your personal data, or exercise any of your legal rights relating to your data, in accordance with the applicable laws and regulations.',
      },
      contactTitle: { ar: 'تواصل معنا', en: 'Contact us' },
      contactBody: {
        ar: 'لأي استفسار يتعلق بخصوصيتك أو بياناتك الشخصية:',
        en: 'For any inquiry related to your privacy or personal data:',
      },
      emailLabel: { ar: 'البريد الإلكتروني', en: 'Email' },
      phoneLabel: { ar: 'رقم التواصل', en: 'Phone' },
    },
    cookies: {
